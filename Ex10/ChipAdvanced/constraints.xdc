...
create_clock -name clk -period 2.0 [get_ports clk_p]

set_property PACKAGE_PIN BD21 [get_ports rst]
set_property IOSTANDARD LVCMOS18 [get_ports rst]
set_property PULLUP true [get_ports rst]

set_property PACKAGE_PIN BA20 [get_ports data]
...
set_property PACKAGE_PIN BC21[get_ports plugs_old]
set_property IOSTANDARD LVCMOS18 [get_ports plugs_old]
set_property PACKAGE_PIN BB21[get_ports temperature_old]
